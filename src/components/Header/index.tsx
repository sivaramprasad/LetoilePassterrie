...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1275px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
    ...
    {/* <!--=== Main Nav Start ===--> */}
            ...
            >
              {/* <!-- Main Nav Start --> */}
              <nav>
                <ul className="flex xl:items-center flex-col xl:flex-row gap-8 xl:gap-6">
            ...
            {/* // <!--=== Main Nav End ===--> */}
            <div className="max-w-[475px] w-full hidden xl:block">
              <form>
                <div className="flex items-center">

                  <div className="relative  w-full">
                    {/* <!-- divider --> */}
                    <span className="absolute left-0 inset-y-0 w-px bg-gray-4"></span>
                    <input
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5 ">
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                <Link href="/signin" className="flex items-center gap-2.5 hidden xl:block">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <button
                  ...
                  className="flex items-center gap-2.5 hidden xl:block"
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5  w-4.5 h-4.5 rounded-full text-white bgred">
                      {product.length}
                    </span>
                  </span>
