            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button
                  ...
                  className={`inline-flex font-medium  bg-blue py-3 px-7 rounded-md ease-out duration-200 hover:bg-blue-dark
                  `}
                >
                  Add to Cart
                </button>
                ...
                <button
                  className={`inline-flex items-center gap-2 font-medium  bg-dark py-3 px-6 rounded-md ease-out duration-200 hover:bg-opacity-95 `}
                >
                  <svg
                    className="fill-current"
                    width="20"
