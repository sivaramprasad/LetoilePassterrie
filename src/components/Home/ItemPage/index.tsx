...
const Categories = ({ item }) => {
        ...
        <div className="modalProductDetailsData">
          <div className="" style={{ overflowX: "hidden" }}>
            <div className="row flex flex-col md:flex-row">
              <div className="col-12 shopping-content d-flex flex-column flex-lg-row align-items-md-top">
  ...
  <Image
    ...
    width={600}
    height={600}
    className="menuimg prodprw rounded pt-30"
  />
</div>

              <div className="px-4 md:px-0 w-full md:w-1/2 prodtext">
  ...
  >
    ...
    <div className="col-6 sm:col-6 w-full sm:w-auto">
      <button
        type="button"
         onClick={() => handleAddToCart()}
        className="btn btn-medium btn-primary bg-blue p-2 b-st1 w-full sm:ml-2"
      >
        Add to Bag
      </button>
    </div>
    <div className="col-2 sm:col-2 min-w-[45px] flex justify-end">
        <button
